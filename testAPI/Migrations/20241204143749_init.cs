        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Histories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Order_Histories_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Payment_Picture = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_Details_Order_Histories_OrderHistoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_Details_OrderHistoryId",
                table: "Order_Details",
                column: "OrderHistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_Histories_UserId",
                table: "Order_Histories",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Order_Histories_UserId1",
                table: "Order_Histories",
                column: "UserId1");
